const { lookupByZipCode, lookupByCityState, getPopulationByState } = require('./zipCodeModule_v2');
...
console.log(`Lookup by zip code (${lookup_zip2})`);
...
console.log(`Lookup by city (${lookup_city2}, ${lookup_state2})`);
print_results('lookupByCityState', city_state_row2, [lookup_city2, lookup_state2]);

console.log();

console.log(`Lookup by city (${lookup_city3}, ${lookup_state3})`);
...
console.log(`Get population by state (${population_state2})`);
print_results('getPopulationByState', population2, [population_state2]);

console.log();

console.log(`Get population by state (${population_state3})`);
